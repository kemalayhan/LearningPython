...
class Film():
    ...
    def __str__(self):
        ...
        return "Film: {}\nYönetmen: {}\nTür: {}\nSüre: {}\nYapımcı:{}".format(self.isim,self.yonetmen,self.tur,self.sure,self.yapimci)
...
class Arsiv():
    ...
    def filmleri_goster(self):
        ...
        if len(filmler) == 0:
            print("Arşivde hiç film bulunmamaktadır....")
    ...
    def film_sorgula(self,film):
        ...
        if len(filmler) == 0:
            print("Aradığınız film bulunmamaktadır....")
    ...
    def tur_guncelle(self,eski_film,yeni_tur):
        ...
        if len(filmler) == 0:
            print("Aradığınız film bulunmamaktadır.....")
            print("1. İşlem ile filmleri görüntüleyip tekrar seçiniz....")
